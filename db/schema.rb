...
ActiveRecord::Schema.define(version: 20171114103245) do
  ...
  add_index "user_comment_changes", ["comment_id", "user_id"], name: "index_user_comment_changes_on_comment_id_and_user_id", unique: true, using: :btree
